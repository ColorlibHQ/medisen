    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = medisen_opt( 'medisen_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo medisen_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( medisen_featured_post_cat() ){
                                echo '<span class="entry__category">'.medisen_featured_post_cat().'</span>';
                            }
                            ?>
