...
// image default alt
if( !function_exists( 'medisen_img_default_alt' ) ){
	function medisen_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'medisen_img_tag' ) ){
	function medisen_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = medisen_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'medisen_anchor_tag' ) ){
	function medisen_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'medisen_heading_tag' ) ){
	function medisen_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'medisen_paragraph_tag' ) ){
	function medisen_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'medisen_other_tag' ) ){
	function medisen_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'medisen_button_element ' ) ){
	function medisen_button_element( array $args ){
