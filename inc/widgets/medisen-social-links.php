...
class Medisen_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'medisen_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Medisen ] Social Links', 'medisen' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'medisen' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'medisen' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'medisen'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'medisen'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'medisen'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'medisen'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'medisen'); ?></label>
...
} // Class medisen_social_links ends here


// Register and load the widget
function medisen_social_links_widget_load() {
	register_widget( 'Medisen_social_links' );
}
add_action( 'widgets_init', 'medisen_social_links_widget_load' );