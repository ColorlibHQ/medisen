...
----------------------------------------*/
class medisen_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('medisen_instagram_photo',esc_html__('[ Medisen ] Intagram Photo','medisen'),array(
			'description' => esc_html__('Medisen Instagram Photo Widget','medisen'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'medisen');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'medisen'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'medisen'); ?></label>
...
if(!function_exists('medisen_instagram_widgets')):
	function medisen_instagram_widgets(){
		register_widget('medisen_instagram_photo');
	}
	add_action('widgets_init','medisen_instagram_widgets');
endif;
