...
/**
 *
 * medisen elementor about page section widget.
 *
 * @since 1.0
 */
class Medisen_Contact extends Widget_Base {

    public function get_name() {
        return 'medisen-contact';
    }

    public function get_title() {
        return __( 'Contact', 'medisen' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'medisen' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'medisen' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'medisen' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'medisen' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'medisen' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'medisen' ),
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'medisen' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'medisen' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'medisen')
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'medisen' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->start_controls_section(
            'style_content_color', [
                'label' => __( 'Style Content Color', 'medisen' ),
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Right Text Title Color', 'medisen' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Right Text Sub Title Color', 'medisen' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#8a8a8a',
                'selectors' => [
